<?php
  ...
  header("Location: usuario_borrar.php");
  exit();
}
...
<div class="container">
  ...
  <div class="panel panel-default">
    <div class="panel-body">
      <form action="usuario_borrado.php" class="form-horizontal" method="post">
        <!--<input type="hidden" name="id">-->
        
        <div class="form-group">
          <label for="id" class="col-sm-2 control-label">Id</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="id" name="id" placeholder="Id del usuario a borrar" required="required">
          </div>
        </div>
