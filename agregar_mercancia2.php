<?php
  ...
  header("Location: agregar_mercancia2.php");
  exit();
}
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="agregar_mercancia2.php">Agregar mercancias</a>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Mercancias">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseTable" data-parent="#exampleAccordion">
            ...
            <ul class="sidenav-second-level collapse" id="collapseTable">
              ...
              <li>
                <a href="mercancia_editar2.php">Editar mercancias</a>
              </li>
              <li>
                <a href="mercancia_borrar2.php">Borrar mercancias</a>
              </li>
              <li>
                <a href="mercancias2.php">Ver mercancias</a>
              </li>
            </ul>
        </li>
