<?php
  ...
  header("Location: mercancia_editar.php");
  exit();
}
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="agregar_mercancia.php">Editar mercancias</a>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">Insertar nombre del cliente para modificación</li>
      </ol>
  <!-- BUSQUEDA-->
    <center>
    <form action="Mercancia_editada.php" method="get">
        <label>Buscar: <input type="text" name="buscar"></label>
        <input type="submit" name="enviando" value="Listo">
        </form> </center>
