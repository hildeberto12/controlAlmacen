<?php
  ...
  header("Location: mercancia_borrar.php");
  exit();
}
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="agregar_mercancia.php">Eliminar mercancias</a>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">Borrar mercancia</li>
      </ol>
...
<div class="container">
  ...
  <div class="panel panel-default">
    <div class="panel-body">
      <form action="mercancia_borrada.php" class="form-horizontal" method="post">
        <!--<input type="hidden" name="id">-->
        
        <div class="form-group">
          <label for="id" class="col-sm-2 control-label">Id</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="id" name="id" placeholder="Id de la mercancia a borrar" required="required">
          </div>
        </div>
        ...
        <div class="col-sm-10 col-sm-offset-2">
          <button class="btn btn-success" type="submit">Borrar <i class="icon-check"></i></button>
